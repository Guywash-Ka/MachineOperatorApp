...
import com.example.backend.TaskService;
...
public class TaskController {
    ...
    public ResponseEntity<List<TemplatesDao>> getTemplates() {
        return new ResponseEntity<>(templatesRepo.findAll(),HttpStatus.OK);
    }
    @GetMapping("/getTemplates/{id}")
    ...
    public ResponseEntity<TaskDto> saveTask(@PathVariable(name = "id")int id){
